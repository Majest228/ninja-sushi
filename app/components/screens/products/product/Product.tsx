	...
	return (
		<Link href={`/products/product/${product.id}`} className={styles.product}>
			<div className={styles.product__content}>
				<Image src={`http://localhost:8080/api/files/${product.productPath}`} width={331} height={290} alt='product' />
				...
				<p className={styles.product__content__desc}>Нори, рис, японский майонез, бальзамик, трюфельная сальса, кунжутное масло</p>
				<div className={styles.product__content__buttons}>
					<div className={styles.product__content__price}>
						<p>190<span>грн</span></p>
					</div>
